...
import { fetchEventById, updateEvent, Event } from '@/lib/api';
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          <h3 className="text-xl font-medium text-gray-600">Event not found</h3>
          <p className="mt-2 text-gray-500">The event you're trying to edit doesn't exist.</p>
          <Link
            href="/admin/events"
